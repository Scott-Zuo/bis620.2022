...
It also includes a functionality of generating spectral signature plots.
The dataset `ukb_accel` included in the package is from UKBiobank for examples and practice use.
